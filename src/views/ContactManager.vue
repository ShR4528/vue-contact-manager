      ...
      <div class="row">
        <div class="col">
          <p class="h3 text-success fw-bold">Contact Manager</p>
            ...
            <p class="fst-italic">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Optio quod officiis magnam saepe molestias eaque ullam, iusto voluptates. Labore, quam.</p>
            <form>
              <div class="row">
              <div class="col-md-6">
                <div class="row">
          ...
          <div class="card my-2 list-group-item-success shadow-lg">
            <div class="card-body">
              <div class="row align-items-center">
                <div class="col-sm-4">
                  <img src="../assets/User_icon_2.svg.png" class="contact-img">
                </div>
                <div class="col-sm-7">
                  <ul class="list-group">
